...
import { ExpatswapMockApiReplyCallback } from '@expatswap/lib/mock-api/mock-api.types';
import { Observable, of, take, throwError } from 'rxjs';

export class ExpatswapMockApiHandler
{
    request!: HttpRequest<any>;
    urlParams!: { [key: string]: string };

    // Private
    private _reply: ExpatswapMockApiReplyCallback = undefined;
     ...
     * @param callback
     */
    reply(callback: ExpatswapMockApiReplyCallback): void
    {
        // Store the reply
