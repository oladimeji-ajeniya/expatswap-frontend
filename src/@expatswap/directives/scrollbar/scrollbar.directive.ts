...
import { ScrollbarGeometry, ScrollbarPosition } from '@expatswap/directives/scrollbar/scrollbar.types';
 ...
 */
@Directive({
    selector  : '[expatswapScrollbar]',
    exportAs  : 'expatswapScrollbar',
    standalone: true,
})
export class ExpatswapScrollbarDirective implements OnChanges, OnInit, OnDestroy
{
    /* eslint-disable @typescript-eslint/naming-convention */
    static ngAcceptInputType_expatswapScrollbar: BooleanInput;
    /* eslint-enable @typescript-eslint/naming-convention */

    @Input() expatswapScrollbar: boolean = true;
    @Input() expatswapScrollbarOptions: PerfectScrollbar.Options;
    ...
    {
        // Enabled
        if ( 'expatswapScrollbar' in changes )
        {
            // Interpret empty string as 'true'
            this.expatswapScrollbar = coerceBooleanProperty(changes.expatswapScrollbar.currentValue);

            // If enabled, init the directive
            if ( this.expatswapScrollbar )
            {
                this._init();
            }
        ...
        // Scrollbar options
        if ( 'expatswapScrollbarOptions' in changes )
        {
            // Merge the options
            this._options = merge({}, this._options, changes.expatswapScrollbarOptions.currentValue);
    ...
    isEnabled(): boolean
    {
        return this.expatswapScrollbar;
    }
