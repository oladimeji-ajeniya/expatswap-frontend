...
// -----------------------------------------------------------------------------------------------------
// @ EXPATSWAP TailwindCSS Main Plugin
// -----------------------------------------------------------------------------------------------------
            ...
            const schemeCustomProps = _.map(
                ...
                (colorScheme) => {
                    ...
                    const background = theme(
                        `expatswap.customProps.background.${colorScheme}`
                    );
                    const foreground = theme(
                        `expatswap.customProps.foreground.${colorScheme}`
                    );
                        ...
                        _.flatten(
                            _.map(
                                ...
                                (name) => [
                                    [
                                        name,
                                        `rgba(var(--expatswap-${name}-rgb), <alpha-value>)`,
                                    ],
                                    [
                                        `on-${name}`,
                                        `rgba(var(--expatswap-on-${name}-rgb), <alpha-value>)`,
                                    ],
                                ]
                            )
                        )
